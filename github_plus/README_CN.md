[![Greasy Fork](https://img.shields.io/greasyfork/dt/510742)](https://greasyfork.org/scripts/510742) [![Support on Afdian](https://img.shields.io/badge/Support-Afdian-%23946CE6?style=flat&logo=afdian)](https://afdian.com/a/PRO-2684)
...
- **📦 Release Features**
    ...
    - **📥 Release Downloads**: 显示 Release 中文件的下载次数。
        - 注意: GitHub 现在会在你的仓库显示下载次数，这可能导致统计信息出现重复。当这个功能拓展至所有仓库时，此选项将被移除。
