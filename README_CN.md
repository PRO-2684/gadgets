...
| [`cleantube`](./cleantube)                        | N/A                                            | 隐藏 Youtube 中部分元素。完全可自定义。                                                                               |
| [`disco`](./disco)                                | N/A                                            | 隐藏 Discord 中烦人的元素。                                                                                           |
...
| 代码片段                                        | 描述                                                                                                                         |
| ----------------------------------------------- | ---------------------------------------------------------------------------------------------------------------------------- |
| [`bad-tempered`](./bad-tempered)                | “脾气暴躁”的下载器 shell 命令，小超时和低延迟的积极重试。                                                                    |
...
| [`devcontainer`](./devcontainer)                | 针对 devcontainer 的一些实用工具。                                                                                           |
...
| [`wait-sh`](./wait-sh) \*                       | 等待某事件发生后再退出，当前支持：进程 PID；NVIDIA GPU 空闲                                                                  |
