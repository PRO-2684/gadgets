[![Greasy Fork](https://img.shields.io/greasyfork/dt/467078?logo=greasyfork)](https://greasyfork.org/scripts/467078) [![Support on Afdian](https://img.shields.io/badge/Support-Afdian-%23946CE6?style=flat&logo=afdian)](https://afdian.com/a/PRO-2684) [![GitHub Repo stars](https://img.shields.io/github/stars/PRO-2684/gadgets?style=flat&logo=github)](https://github.com/PRO-2684/gadgets/tree/main/greasyfork_enhance)
...
- `rating:`: 按评分过滤脚本。语法同 `total:`，但数字取值为 0-1 之间的小数，并且不允许 `=` 操作符，例如 `rating:>0.9`
- `created:`: 按创建时间过滤脚本
    - `>2026-01-01T01:23:45`: 仅显示在 2026 年 1 月 1 日 01:23:45 之后创建的脚本
    - `<2026-01-01`: 仅显示在 2026 年 1 月 1 日 00:00:00 之前创建的脚本
    - 若操作符省略，则默认为 `>`，例如 `created:2026-01-01` 等价于 `created:>2026-01-01`
    - 注意：此处不支持 `=` 操作符
    - 参考 [MDN](https://developer.mozilla.org/en-US/docs/Web/JavaScript/Reference/Global_Objects/Date#date_time_string_format) 以了解支持的日期时间格式
- `updated:`: 按更新时间过滤脚本，语法同 `created:`
